...
test('resizes an image by dimensions or percentage and offers a local download', async ({ page }) => {
...
test('converts an image locally with an accurate download type and filename', async ({ page }) => {
