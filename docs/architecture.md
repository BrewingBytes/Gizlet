...
GitHub Actions validates pull requests. It installs from the lockfile and runs checks, tests, the production build, and Playwright smoke tests without deployment secrets.
