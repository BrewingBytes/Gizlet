...
const relatedToolSlugs: Record<AvailableToolSlug, readonly AvailableToolSlug[]> = {
  ...
  'json-formatter': ['json-csv-converter', 'json-ld-generator', 'url-encode-decode'],
  'json-csv-converter': ['json-formatter', 'json-ld-generator', 'url-encode-decode', 'base64-encode-decode'],
