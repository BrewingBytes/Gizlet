...
const relatedToolSlugs: Record<AvailableToolSlug, readonly AvailableToolSlug[]> = {
  ...
  'url-encode-decode': ['base64-encode-decode', 'json-formatter', 'uuid-generator', 'json-ld-generator'],
  'uuid-generator': ['url-encode-decode', 'base64-encode-decode', 'json-formatter', 'json-ld-generator'],
  'base64-encode-decode': ['url-encode-decode', 'uuid-generator', 'json-formatter', 'convert-image'],
