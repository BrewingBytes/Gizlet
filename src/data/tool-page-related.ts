...
const relatedToolSlugs: Record<AvailableToolSlug, readonly AvailableToolSlug[]> = {
  ...
  'convert-image': ['compress-image', 'resize-image', 'image-color-picker', 'crop-image', 'jpg-to-pdf'],
  ...
  'json-formatter': ['json-csv-converter', 'csv-viewer', 'json-ld-generator', 'url-encode-decode'],
  'json-csv-converter': ['csv-viewer', 'json-formatter', 'json-ld-generator', 'url-encode-decode'],
  'csv-viewer': ['json-csv-converter', 'json-formatter', 'url-encode-decode', 'extract-archive'],
  'url-encode-decode': ['base64-encode-decode', 'jwt-decoder', 'json-formatter', 'uuid-generator'],
  'uuid-generator': ['url-encode-decode', 'base64-encode-decode', 'json-formatter', 'json-ld-generator'],
  'base64-encode-decode': ['jwt-decoder', 'url-encode-decode', 'uuid-generator', 'json-formatter'],
  'jwt-decoder': ['timestamp-converter', 'base64-encode-decode', 'json-formatter', 'url-encode-decode'],
  'file-hash-generator': ['extract-archive', 'create-zip', 'base64-encode-decode', 'uuid-generator'],
  'timestamp-converter': ['jwt-decoder', 'json-formatter', 'uuid-generator', 'url-encode-decode'],
  'jpg-to-pdf': ['pdf-to-jpg', 'merge-pdf', 'watermark-pdf', 'pdf-viewer'],
  'pdf-viewer': ['organize-pdf', 'sign-pdf', 'pdf-to-jpg', 'merge-pdf', 'jpg-to-pdf'],
  'create-zip': ['extract-archive', 'file-hash-generator', 'compress-image', 'jpg-to-pdf', 'split-pdf'],
  'extract-archive': ['create-zip', 'file-hash-generator', 'compress-image', 'convert-image', 'pdf-viewer'],
